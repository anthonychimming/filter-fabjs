...
export function initFilterFabApp(){
  ...
  function prepareFilter(input){
    ...
    return{legacyMath,formulas:normalizedFormulas,controls,labels,name,description,author,program};
  }
