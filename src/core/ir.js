...
const MASK_FUNCTIONS=new Set('step smoothstep hash2 valueNoise perlin worleyF1 worleyF2 fbm turbulence ridged periodicNoise linearGrad radialGrad angularGrad checker brick'.split(' '));
