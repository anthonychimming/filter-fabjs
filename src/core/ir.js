...
const MASK_FUNCTIONS=new Set('step smoothstep hash2 valueNoise perlin worleyF1 worleyF2 fbm turbulence ridged periodicNoise mandelbrot julia linearGrad radialGrad angularGrad checker brick line circle ring box triangle grid sierpinski'.split(' '));
