...
export function getDom(){
  const el={canvas:$('#displayCanvas'),stage:$('#canvasStage'),wrap:$('#canvasWrap'),drop:$('#dropOverlay'),renderOverlay:$('#renderOverlay'),progressFill:$('#progressFill'),progressPercent:$('#progressPercent'),progressRows:$('#progressRows'),controlsUsage:$('#controlsUsage'),formulaEditStatus:$('#formulaEditStatus'),renderBtn:$('#renderBtn'),imageInput:$('#imageInput'),filterInput:$('#filterInput'),preset:$('#presetSelect'),deletePreset:$('#deletePresetBtn'),rendererSelect:$('#rendererSelect'),formulas:[$('#formulaR'),$('#formulaG'),$('#formulaB'),$('#formulaA')],statusDot:$('#statusDot'),statusText:$('#statusText'),imageInfo:$('#imageInfo'),renderInfo:$('#renderInfo'),split:$('#splitRange'),splitControl:$('#splitControl'),zoomLabel:$('#zoomLabel'),toast:$('#toast')};
