...
assert.equal(presets.length, 35, 'v2.8.3 must expose the revised built-in catalog size');
...
assert.equal(presets.length,35,'v2.8.3 must expose 26 retained plus nine contributed built-in filters');
