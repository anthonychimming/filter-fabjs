...
const standalone=new URLSearchParams(location.search).has('standalone'),html=await(await fetch(new URL(standalone?'dist/filter-fabjs-v2.9.1.html':'index.html',root))).text();
