...
- Ten data-driven formula controls plus normalized/centered coordinates, coordinate repetition, polar helpers, and palette ramps.
- WebGPU acceleration with automatic CPU fallback for unsupported or legacy formulas.
- Built-in image-processing and procedural filters, including analytic shapes, patterns, gradients, noise, convolution, bounded Mandelbrot/Julia fields, and fractal masks.
...
- `dist/filter-fabjs-v2.6.1.html` — standalone single-file distribution.
