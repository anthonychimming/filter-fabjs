...
**Current stable release: v2.8.5b**
...
Filter FabJS v2.8.5b uses a typed, renderer-neutral intermediate representation, with the CPU and WebGPU renderers consuming the same semantic formula program.
...
- `dist/filter-fabjs-v2.8.5b.html` — standalone single-file distribution.
